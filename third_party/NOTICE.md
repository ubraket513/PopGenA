...
Native Bowtie2 2.5.5 (GPL-3.0-or-later) and community Windows fastp 1.3.3 (upstream MIT, separately licensed runtime components) are downloaded using tools/raw-tools.lock.json. Bowtie2 LICENSE is retained beside its executables. See docs/NATIVE_TOOLS.md for exact release/source links and the fastp archive's incomplete redistribution notices. Neither binary is committed or relicensed here.
